...
import {
  TrendingUp, Shield, BarChart2, Repeat,
  FileText, Landmark, Lock, Target, PieChart, ArrowUpRight,
} from "lucide-react";
import SectionHeader from "../ui/SectionHeader";
import ScrollReveal from "../ui/ScrollReveal";
import { products, services } from "../../data/services";
    ...
    <section className="bg-white py-14">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <SectionHeader
          ...
          subtitle="Explore our products and goal-based services."
          className="mb-10"
        />

        <h3 className="text-textprimary font-semibold text-base mb-4">Products</h3>
        <ServiceCardGrid items={products} />

        <h3 className="text-textprimary font-semibold text-base mb-4 mt-10">Services</h3>
