...
//     a: "We maintain Hi hi! 👋 I'm here to help you with questions about mutual fund distribution and our services. What would you like to know?
// Quick questions:
...
// Do you charge fees?
// Can I start a SIP?
// Yes. We can assist you with goal-based SIP investments — such as for children's education, marriage, or buying a home — but our recommendations are limited to mutual fund schemes only.
// how to start sip?
// Yes. We can assist you with goal-based SIP investments — such as for children's education, marriage, or buying a home — but our recommendations are limited to mutual fund schemes only.
// start investing
// Yes. We can assist you with goal-based SIP investments — such as for children's education, marriage, or buying a home — but our recommendations are limited to mutual fund schemes only.
// why do i need insurance if healthy
// It's natural to feel that way — but insurance is easiest to get exactly when you feel you don't need it. While you're healthy, insurers are happy to cover you. Once an illness shows up, insurers can decline cover or charge much more for it. Getting covered while you're healthy is what makes the protection valid for when you actually need it.
// is it safe
// Mutual funds are SEBI-regulated investment products. However, they are subject to market risk. Please read all scheme-related documents carefully before investing. Past performance does not guarantee future returns.
// what does radds capital do
// Radds Capital is an AMFI-registered Mutual Fund Distributor (MFD). We help you invest in mutual funds by understanding your risk profile and investment goals, and assisting you in executing transactions. We do not provide investment advice or financial planning services.
// let's go
// I don't have a specific answer for that. Please connect with us on WhatsApp and our team will be happy to assist you. Radds Capital — AMFI-Registered MFD (ARN-334716 | ARN-292158 | ARN-124053).Chat on WhatsApprecords of your risk profile, scheme suitability assessments, and transaction correspondence as required under AMFI and SEBI guidelines.",
//   },
//   {
...
//   );
//   if (matched) return { text: matched.a, type: matched.type };
