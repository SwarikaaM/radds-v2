...
const FAQS = [
  ...
  },
  {
    ...
    a: "You can reach out to us on WhatsApp and we will guide you through KYC completion, risk profiling, and scheme selection based on your goals.",
  },
  {
...
function getBotReply(input, userName) {
  ...
  const keywords = [
    ["sip", "invest", "start", "begin", "mutual fund", "fund"],
